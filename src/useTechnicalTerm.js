...
export const useTechnicalTerm = () => {
  const [technicalTerm, setTechnicalTerm] = useState([
    ...
    },
    {
      ...
      explanation:
        '細胞増殖にブレーキに働いたり、細胞死を誘導する、正常な細胞ではがんを抑制する機能を持つ遺伝子の総称。それぞれ、転写抑制(P53,Rb)・細胞周期制御(p16)・ユビキチン化(APC)・DNA修復(BRCA1,BRCA2)などを制御している。両アレルに変異が入ってがん化する理論→2hit theoryは今では否定されていて、ヘテロ接合性が遺伝子組み換えにより消失してがん抑制遺伝子が不活性化されるLost Of Hetero/LOHという理論が現在は主流。',
    },
    {
    ...
    {
      term: ['ミューテーター遺伝子',"caretaker gene","MLT"],
      explanation:
        'ミスマッチ修復、DNA切断修復機構などの遺伝子修復に関わる遺伝子。Caretaker geneとも呼ばれ、この遺伝子の両アレルに変異が入ると遺伝子修復が機能しなくなりがん化しやすくなる。MLH1・MLH2の変異/μサテライト不安定性MSI→lynch症候群・大腸がん、BRCA1/BRCA2の変異→乳がん・卵巣がんなど',
    },
    {
      term: ['PARP阻害剤'],
      explanation:
        'PARP1を阻害することによって、BRCA1・2に異常がある乳がん細胞はDNA修復（非相同的末端連結）できなくなり細胞死することを利用した抗がん剤。',
    },
    {
      term: ['スプライシング変異'],
      explanation:
    ...
    {
      term: ['2段階発がん',"イニシエーター","プロモーター"],
      explanation:
        '発がんには突然変異を引き起こす変異原（イニシエーター/アゾキシメタンなど）と、変異細胞の生存は変異の存続を誘導する発がんプロモーター（デオキシコール酸など）の2段階によって起こるとする理論。two-hit theory(がん抑制遺伝子の不活化には両アレルの変異が必要とする理論)とは全く異なる考え方。',
    },
    ,
    // {
    //   term: ['がん幹細胞'],
    ...
    // },
    {
      term: ['脂肪肝'],
      explanation:
        '肝細胞内へのトリグリセリドの蓄積。肝重量の7%以上/肝細胞の5%以上に脂肪滴が発生すると脂肪肝に分類される。糖尿病・飢餓時の脂肪利用亢進（→大滴型）、アルコール性肝炎、肝臓毒などによって肝細胞障害（→小滴型）による脂肪酸酸化障害などが原因。',
    },
    {
    ...
    },
    {
      ...
      explanation: '転写調節を担うがん抑制遺伝子Rbの不活化により家族性網膜芽細胞腫を発生する。',
    },
    {
    ...
    {
      term: ['ATP', 'adenosine triphosphate', 'アデノシン3リン酸'],
      explanation:
        'ATPは解糖系で2分子、TCAサイクルで2分子、電子伝達系で最大34分子生成される。アデニン+リボース+リン酸3個',
    },
    {
      term: ['CrP', 'クレアチン'],
      explanation:
        'ATPは生体内ですぐ利用されてしまうため、クレアチンをリン酸化した形で貯蔵している(phosphagenのひとつ)。細胞質とミトコンドリアの間をクレアチンリン酸とクレアチンが移行してエネルギー原を移動させるシャトルをクレアチンシャトルとよぶ。',
    },
    {
      term: ['GLUT', 'LAT', 'ASCT', 'MCT'],
      explanation:
        'がん細胞では解糖系が亢進するため、GLUT1の発現が亢進している。解糖系産物の乳酸を排出するためMCT1の発現も亢進している。がん細胞ではTCA回路が抑制されているため、必須アミノ酸EAAを取り込むLAT1、グルタミン酸を取り込むASCT2の発現も亢進している。これらは全てトランスポーターである。',
    },
    {
      term: ['マクロピノサイトーシス'],
      explanation:
        'エンドサイトーシスのひとつ。がん細胞ではc-SrcやKRASの発現が亢進されていて比較的大きいタンパク質や脂質をそのまま細胞内に取り込んで、アミノ酸として利用できる。がん細胞ではTCA回路が抑制されていて、アミノ酸や脂質が不足する傾向がある。',
    },
    {
      term: ['エントーシス'],
      explanation:
        'エンドサイトーシスのひとつ。がん細胞ではKRASの発現が亢進していて、周辺細胞を細胞内に取り込んで栄養源として利用できる。',
    },
    {
      term: ['ファゴサイトーシス'],
      explanation:
        'エンドサイトーシスのひとつ。アポトーシスした細胞を取り込んで栄養源として利用する。がん細胞ではファゴサイトーシスが活発。',
    },
    {
      term: ['one-carbon代謝', '3-ホスホグリセリン酸'],
      explanation:
        '解糖系中間体の3-ホスホグリセリン酸はセリンやシステインの合成元になる(one-carbon代謝)ので重要。',
    },
    {
      term: ['NADPH', 'NADP⁺'],
      explanation:
        'NADPHは主にペントースリン酸経路PPPで生成される還元剤。脂肪酸・コレステロール・ヌクレオチド・アミノ酸合成に使われたり、抗酸化作用をもつ。',
    },
    {
      term: ['PKM', 'Pyruvate Kinase'],
      explanation:
        'ピルビン酸キナーゼのひとつ。4量体を形成することで活性型となる。PKM2は解糖系中間産物によってアロステリックに活性化する。PKM2は正常細胞にもみられるが、がん細胞でも亢進されていて、がん細胞で抑制されているTCA回路で産生されるはずであったアミノ酸や脂肪をグルタミンから補うような活動をする。現在ではPKM2だけでなくPKM1もがん治療のターゲットとなることが多いらしい。',
    },
    {
      term: ['Glud1'],
      explanation:
    ...
    },
    {
      ...
      explanation:
        'ミトコンドリアにある環状二本鎖のDNA。1つのミトコンドリアに5～10個のmtDNAが存在していて、完全に母親から遺伝する。イントロンは存在せず、呼吸鎖複合体のうち1,3,4,5の一部の遺伝子をコードしている。',
    },
    {
      term: ['mitophagy'],
      explanation:
        'ミトコンドリアを除去する機構。ミトコンドリアの膜電位が低下するとPINKやParkinがユビキチンをリクルートする。がん細胞ではmitophagy機能が低下していて、異常ミトコンドリアが蓄積しているといわれている→がん細胞は解糖系にエネルギー代謝を依存している？',
    },
    // {
    //   term:[''],
    //   explanation:'',
