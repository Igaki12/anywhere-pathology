...
export const useTechnicalTerm = () => {
  const [technicalTerm, setTechnicalTerm] = useState([
    ...
    },
    {
      ...
      explanation:
        '自己複製能・多分化能をもち、1個から新しい集団を作れるため、がんの転移・再発に深く関与している。放射線治療抵抗性・活性酸素除去能（ALDH1活性亢進）・DNA修復能の亢進など。薬剤排出トランスポーターが過剰発現しており、分裂が緩やかであるため抗がん剤抵抗性をもつ。がん幹細胞のWNT経路やNOTCH経路をターゲットにした治療法が研究されている。分化したがん細胞からは容易にがん幹細胞へ戻れる。',
    },
    {
    ...
    },
    {
      term: ['肺分画症'],
      explanation:
        '以上動脈による肺の一部の体循環による潅流。気管支に繋がっていない部分で慢性炎症を起こすこともある。',
    },
    {
