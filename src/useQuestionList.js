      ...
      groupContents: [
        {
          ...
          questionImg: [],
          questionSentence:
            '【〇✖問題】13トリソミーでは馬蹄腎・臍ヘルニア・揺り椅子状の測定を認めることが多い。',
          answerImg: [],
          answer: '✖...13ではない',
          commentary: '',
        },
        ...
        },
        {
          ...
          questionImg: [],
          questionSentence:
            '【〇✖問題】1分子のグルコースから最も多くのATPを生成するのは解糖系である。',
          answerImg: [],
          answer: '✖...解糖系ではなく電子伝達系',
          commentary: '',
        },
        {
          ...
          questionImg: [],
          questionSentence:
            '【〇✖問題】Ⅲ型アレルギーはTcやマクロファージにより好酸球が増殖することで生じる。',
          answerImg: [],
          answer: '✖...Ⅲ型ではなくⅣ型',
          commentary: '',
        },
        {
          ...
          questionImg: [],
          questionSentence:
            '【〇✖問題】Ⅳ型アレルギーでは免疫複合体の形成により補体が活性化されることで細胞が傷害される。',
          answerImg: [],
          answer: '✖...Ⅳ型ではなくⅢ型アレルギー',
          commentary: '',
        },
        {
          detailInfo: '',
          questionImg: [],
          questionSentence:
            '【〇✖問題】AA型アミロイドは血清アミロイドAAタンパクに由来する。',
          answerImg: [],
          answer: '✖...AA蛋白ではなくA蛋白',
          commentary: '',
        },
        {
          detailInfo: '',
          questionImg: [],
          questionSentence: '【〇✖問題】AGEの増加は大腸がんのリスクとなる',
          answerImg: [],
          answer: '〇',
          commentary: '',
        },
        {
          ...
          questionImg: [],
          questionSentence:
            '【〇✖問題】Alzheimer病ではβアミロイドが沈着した老人斑により錐体外路障害を認める。',
          answerImg: [],
          answer: '✖...錐体外路障害ではない',
          commentary: '',
        },
        {
          ...
          questionImg: [],
          questionSentence:
            '【〇✖問題】CD4+T細胞にTGFβが作用するとTh1,Th17,ないしTregに分化する。',
          answerImg: [],
          answer: '',
          commentary: '',
        },
        {
          ...
          questionImg: [],
          questionSentence:
            '【〇✖問題】Chediak-Higashi症候群では化生酸素の産生異常により殺菌能が低下する。',
          answerImg: [],
          answer: '',
          commentary: '',
        },
